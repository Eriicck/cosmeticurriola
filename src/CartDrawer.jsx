    ...
    <div className="fixed inset-0 z-[60] flex">
      ...
      <div className="relative ml-auto flex w-full max-w-md flex-col bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
          <h2 className="text-base font-medium text-gray-900 tracking-wide">
            Tu carrito ({cartCount})
          </h2>
          {/* X — z-index alto para que no quede debajo del backdrop */}
          <button
            onClick={onClose}
            className="relative z-10 p-1.5 text-gray-400 hover:text-gray-900 transition-colors rounded-full hover:bg-gray-100"
          >
              ...
              <div className="border-t border-gray-100 p-6 space-y-4 bg-white">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-semibold text-gray-900">
                    ${cartTotal.toFixed(2)} <span className="text-sm font-normal text-gray-400">USD</span>
                  </span>
                </div>
                <button
